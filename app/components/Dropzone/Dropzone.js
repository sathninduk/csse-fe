...
import {UploadTemplate} from "@/services/MarketplaceService";

const API_URL = "";

export default function Dropzone({setTemplateName, uploadPercentageData}) {
    ...
    const onDrop = useCallback((acceptedFiles) => {
        ...
        acceptedFiles.forEach((file) => {
            ...
            UploadTemplate(file).then((response) => {
                console.log(response)
                setTemplateName(response.fileName);
            }).catch((error) => {
                setError(true);
